...
----> before: result   += "\t"    + each   . getMovie  ( )  . getTitle  ( )   + "\t"     + String   . valueOf  ( thisAmount    )   + "\n"     
----> after: result   -= "\t"    + each   . getMovie  ( )  . getTitle  ( )   + "\t"     + String   . valueOf  ( thisAmount    )   + "\n"     
----> line number in original file: 59
----> mutated nodes: 163
*/ 
