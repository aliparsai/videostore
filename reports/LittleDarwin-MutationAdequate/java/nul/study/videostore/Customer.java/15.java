...
----> before: result   += "You earned "    + String   . valueOf  ( frequentRenterPoints    )   + " frequent renter points\n"     
----> after: result   -= "You earned "    + String   . valueOf  ( frequentRenterPoints    )   + " frequent renter points\n"     
