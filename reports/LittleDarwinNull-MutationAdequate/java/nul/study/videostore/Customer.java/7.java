/* LittleDarwin generated mutant
 ...
 ----> before: new NullPointerException  ( "name is Null"     )    
----> after:  null 
...
package nul . study . videostore  ;
 ...
 public  class Customer { public   Customer ( String   name    )  throws NullPointerException   { if ( name   == null     )  throw  null /*  NullPointerException  ( "name is Null"      ) */      ;
   this   . name  = name     ;
