/* LittleDarwin generated mutant
 ...
 ----> before: new Rental  ( new RegularMovie  ( null     )     , 0     )    
----> after:  null 
----> line number in original file: 18
*/ 
...
package nul . study . videostore  ;
 ...
 public  class Customer { public   Customer ( String   name    )  throws NullPointerException   { if ( name   == null     )  throw new NullPointerException  ( "name is Null"     )     ;
   this   . name  = name     ;
  }      public   void addRental ( Rental   rental    )  throws NullPointerException   { if ( rental   == null     )  rentals   . addElement  (  null /*  Rental  ( new RegularMovie  ( null     )     , 0      ) */       )   ;
