...
----> after: return null 
----> line number in original file: 30
*/ 
...
package nul . study . videostore  ;
 public  abstract  class Movie { public   static   final   int   REGULAR  = 0       ;
  ...
  }      public   String   getTitle ( )  { return null /*  title    */ ;   }      public   double   determineAmount ( int   daysRented    )  throws Exception   { if ( daysRented   <= 0     )  throw new Exception  ( "Invalid value for daysRented."     )     ;
   return 0    ;
