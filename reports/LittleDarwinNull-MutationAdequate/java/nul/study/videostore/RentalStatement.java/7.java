/* LittleDarwin generated mutant
 ...
 ----> before: return formatRentalLine   ( rental   , thisAmount    )  ;
...
package nul . study . videostore  ;
 ...
 public  class RentalStatement { private   String   name    ;
  ...
  }      private   void clearTotals ( )  { totalAmount   = 0      ;
  ...
  return null /*  formatRentalLine   ( rental   , thisAmount    )   */ ;   }      private   String   formatRentalLine ( Rental   rental   , double   thisAmount    )  { return "\t"    + rental   . getMovie  ( )  . getTitle  ( )   + "\t"     + thisAmount    + "\n"     ;
