/* LittleDarwin generated mutant
 ...
 ----> before: return "\t"    + rental   . getMovie  ( )  . getTitle  ( )   + "\t"     + thisAmount    + "\n"     ;

----> after: return null 
----> line number in original file: 52
*/ 
...
package nul . study . videostore  ;
 ...
 public  class RentalStatement { private   String   name    ;
  ...
  }      private   String   formatRentalLine ( Rental   rental   , double   thisAmount    )  { return null /*  "\t"    + rental   . getMovie  ( )  . getTitle  ( )   + "\t"     + thisAmount    + "\n"      */ ;   }      private   String   makeSummary ( )  { return "You owed "    + totalAmount    + "\n"     + "You earned "     + frequentRenterPoints    + " frequent renter points\n"     ;
