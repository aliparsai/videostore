/* LittleDarwin generated mutant
 ...
 ----> before: return rentalLines   ;

----> after: return null 
----> line number in original file: 40
*/ 
...
package nul . study . videostore  ;
 ...
 public  class RentalStatement { private   String   name    ;
  ...
  for ( Rental   rental  : rentals     ) rentalLines   += makeRentalLine   ( rental    )    ;
   return null /*  rentalLines    */ ;   }      private   String   makeRentalLine ( Rental   rental    )  throws Exception   { double   thisAmount  = rental   . determineAmount  ( )      ;
